...
/* ======================================================================== */
/***
 * Lab Stud.206 MPICH compilation:
 *  /opt/nfs/mpich-3.2/bin/mpicc -o mc_pi_serv_mpi mc_pi_serv_mpi.c -lm
 * Lab Stud.206 MPICH example execution:
 *  /opt/nfs/mpich-3.2/bin/mpiexec -n 4 ./mc_pi_serv_mpi 0.000001
 */
