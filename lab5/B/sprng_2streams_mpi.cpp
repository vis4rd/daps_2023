...
/**** WFiIS Stud.206 Lab (2016):

 *** Compile with SPRNG 5:
$ /opt/nfs/mpich-3.2/bin/mpicxx -DUSE_MPI -DSPRNG_MPI -o sprng_2streams_mpi \
sprng_2streams_mpi.cpp -I/opt/nfs/sprng5/include -L/opt/nfs/sprng5/lib -lsprng

 *** Run (on localhost):
 $ /opt/nfs/mpich-3.2/bin/mpiexec -n 4 ./sprng_2streams_mpi
...
int main(int argc, char *argv[])
{
    ...
    nstreams = nprocs + 1; /* The total number of generators */
