 ...
 *** Compile with SPRNG 5:
 $ /opt/nfs/mpich-3.2/bin/mpicxx -DSPRNG_MPI -DUSE_MPI -o sprng_message_mpi \
 sprng_message_mpi.cpp -I/opt/nfs/sprng5/include -L/opt/nfs/sprng5/lib -lsprng

 *** Run (on localhost, only 2 processes needed):
 $ /opt/nfs/mpich-3.2/bin/mpiexec -n 2 ./sprng_message_mpi
